                  ...
                  return (
                    <div key={t.id} className="flex items-center gap-4 p-3 rounded-xl hover:bg-zinc-50 border border-zinc-100">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[11px] text-zinc-500">{t.slug}.friendlycrm.app · {t.plan} plan</p>
                      </div>
                  ...
                  <div key={t.id} className="flex items-center gap-4 p-3.5 rounded-xl border border-zinc-100 hover:bg-zinc-50 flex-wrap">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[11px] text-zinc-500 truncate">
                        <span className="font-mono text-indigo-500">{t.slug}.friendlycrm.app</span> · 🏢 {branchName(t.branchId)} · since {new Date(t.createdAt).toLocaleDateString('en-IN', { month: 'short', year: 'numeric' })}
                      </p>
                    </div>
          ...
          <div className="bg-white rounded-2xl border border-zinc-200/60 p-6 space-y-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input defaultValue="smtp.friendlycrm.app" className="w-full px-3 py-2.5 bg-zinc-50 border border-zinc-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20" />
              </div>
              <div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 animate-fade-in" onClick={e => e.stopPropagation()}>
            ...
            <form onSubmit={handleAddBuilder} className="space-y-3">
              <div>
                ...
                <p className="text-[10px] text-zinc-400 mt-1">Workspace: <span className="font-mono text-indigo-500">company-name.friendlycrm.app</span></p>
              </div>
              ...
              <div className="flex items-start justify-between mb-4">
                <div>
                  ...
                  <p className="text-xs text-zinc-500 mt-0.5">
                    <span className="font-mono text-indigo-500">{t.slug}.friendlycrm.app</span> · {t.plan} plan ·{' '}
